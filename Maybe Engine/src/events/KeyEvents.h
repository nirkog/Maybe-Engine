...
namespace mb {
	...
	public:
		...
		inline bool HasMod(int mod) const { return mod & m_Mods; }
		inline bool HasMod(KeyMod mod) const { return ((int) mod) & m_Mods; }
		inline int GetMods() const { return m_Mods; }
	protected:
		KeyEvent(int keyCode, int mods)
			: m_KeyCode((KeyCode) keyCode), m_Mods(mods) { }
	...
	{
	public:
		KeyPressedEvent(int keyCode, int mods, bool repeat)
			: KeyEvent(keyCode, mods), m_Repeat(repeat) { }
	...
	public:
		...
		static EventType GetStaticType() { return EventType::KeyTypedEvent; }
		EventType GetType() const { return GetStaticType(); }
	};
